...
class ComSerController extends Controller
{
    public function index(Request $request)
    {
        $task = ComunidadServicio::all();
        return $task;
    ...
    {
        $task = ComunidadServicio::findOrFail($request->id_comunity);
        return $task;
    ...
    {
        $task = ComunidadServicio::destroy($request->id_comunity);  //task tienen el id que se ha borrado
