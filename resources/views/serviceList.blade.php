...
<div class="row">
  <nav id="nav" class="navbar navbar-expand-xl navbar-light d-none d-xl-block">
    ...
    <div class="row">
      <div class="aside flex-shrink-0 col-3" >
        <a href="/usuarios" class="d-flex align-items-center justify-content-center py-2 mb-3 text-decoration-none border-bottom">
          ...
          <li class="mb-1">
            ...
            <div class="subelement collapse show" id="home-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a href="/usuarios" class="link-light rounded fs-4">Users</a></li>
